...
exports.EpicFloatingInput = void 0;
...
var _inputFooter = require("./input-footer");
...
const EpicFloatingInput = ({
  ...
  const [charLength, setCharLength] = (0, _react.useState)(0); // ***** Epic Floating Input Animation ***** //

  const DefaultAnimationVal = {
    x: left !== null && left !== void 0 && left.icon ? 40 : 8,
    y: _reactNative.Platform.OS === "android" ? 11 : 16
  };
  const [animatePlaceholder] = (0, _react.useState)(new _reactNative.Animated.ValueXY(DefaultAnimationVal));
  ...
  const _AnimatePlaceholder = () => {
    ...
    _reactNative.Animated.timing(animatePlaceholder, {
      toValue: {
        x: 7,
        y: _reactNative.Platform.OS === "android" ? -13 : -8
      },
      duration: 200,
  ...
  const ModeStyles = {
    ...
    [Mode.dark]: {
      ...
      backgroundColor: isFocused ? (0, _utils.shadeColor)(variantStyles[InputType].color || "#000", 30) : "transparent"
    }
  }; // End
  ...
  const InputStyles = {
    ...
    width: "100%",
    borderRadius: 14,
    backgroundColor: inputType === "outline" ? mode === "light" ? "white" : "transparent" : (0, _utils.shadeColor)(variantStyles[InputType].color || "#000", 20)
  };
  const LabelStyles = {
    fontSize: 14,
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    ...
    style: [LabelStyles]
  }, placeholder))), /*#__PURE__*/_react.default.createElement(_reactNative.TouchableWithoutFeedback, {
    onBlur: !charLength ? _ResetAnimation : undefined
  }, /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: Row
  }, typeof (left === null || left === void 0 ? void 0 : left.icon) === "string" ? /*#__PURE__*/_react.default.createElement(_reactNative.View, {
  ...
  })) : left !== null && left !== void 0 && left.icon && /*#__PURE__*/_react.default.isValidElement(left === null || left === void 0 ? void 0 : left.icon) ? left.icon : null, /*#__PURE__*/_react.default.createElement(_reactNative.View, {
  ...
  }, rest))), typeof (right === null || right === void 0 ? void 0 : right.icon) === "string" ? /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: IconContainerStyle
  ...
  }))) : right !== null && right !== void 0 && right.icon && /*#__PURE__*/_react.default.isValidElement(right.icon) ? right.icon : null))), /*#__PURE__*/_react.default.createElement(_inputFooter.InputFooter, {
...
exports.EpicFloatingInput = EpicFloatingInput;
